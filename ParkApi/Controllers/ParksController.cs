...
namespace ParkApi.AddControllers
{
  ...
  [ApiController]
  public class ParksV1Controller : Controller
  {
    private readonly ParkApiContext _db;
    public ParksV1Controller(ParkApiContext db)
    {
      _db = db;
    }
  ...
  [Route("api/{v:apiVersion}/parks")]
  [ApiController]
  public class ParksV2Controller : Controller
  {
    private readonly ParkApiContext _db;
    public ParksV2Controller(ParkApiContext db)
    {
      _db = db;
    }
